...
{
    /// <inheritdoc />
    public partial class initialhasmanyfklabel : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_WorkGroups_Employees_EmployeesEmployeeId",
            ...
            migrationBuilder.InsertData(
                table: "WorkGroups",
                columns: new[] { "WorkGroupId", "EmployeesEmployeeId" },
                values: new object[,]
                {
                    { 1, null },
                    { 2, null }
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WorkGroups_EmployeesEmployeeId",
                table: "WorkGroups",
